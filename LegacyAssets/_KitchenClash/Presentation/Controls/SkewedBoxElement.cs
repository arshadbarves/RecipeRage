...
namespace KitchenClash.Presentation.Controls
{
    ...
    public partial class SkewedBoxElement : VisualElement
    {
        ...
        [Tooltip("Horizontal skew angle in degrees.")]
        ...
        private void DrawSkewedRoundedRectBorder(Painter2D painter, Vector2 tl, Vector2 tr, Vector2 br, Vector2 bl, float radius, float progress)
        {
            ...
            {
                Vector2 trEnd2 = Vector2.Lerp(tr, tl, radius / topLen);
                painter.LineTo(trEnd2);
                currentLen += edgeLen;
            }
            else
            {
                ...
                Vector2 trEnd2 = Vector2.Lerp(tr, tl, radius / topLen);
                painter.LineTo(Vector2.Lerp(tlStart, trEnd2, t));
                return;
            }

            if (currentLen + cornerLen <= targetLen)
            {
                Vector2 trCornerEnd2 = Vector2.Lerp(tr, br, radius / rightLen);
                painter.BezierCurveTo(tr, tr, trCornerEnd2);
            ...
            if (currentLen + edgeLen <= targetLen)
            {
                Vector2 brEnd2 = Vector2.Lerp(br, tr, radius / rightLen);
                painter.LineTo(brEnd2);
                currentLen += edgeLen;
            }
            else
            {
            ...
            if (currentLen + cornerLen <= targetLen)
            {
                Vector2 brCornerEnd2 = Vector2.Lerp(br, bl, radius / bottomLen);
                painter.BezierCurveTo(br, br, brCornerEnd2);
                currentLen += cornerLen;
            }
            else return;
            ...
            if (currentLen + edgeLen <= targetLen)
            {
                Vector2 blEnd2 = Vector2.Lerp(bl, br, radius / bottomLen);
                painter.LineTo(blEnd2);
                currentLen += edgeLen;
            }
            else
            {
            ...
            if (currentLen + cornerLen <= targetLen)
            {
                Vector2 blCornerEnd2 = Vector2.Lerp(bl, tl, radius / leftLen);
                painter.BezierCurveTo(bl, bl, blCornerEnd2);
                currentLen += cornerLen;
            }
            else return;
            ...
            if (currentLen + edgeLen <= targetLen)
            {
                Vector2 tlEnd2 = Vector2.Lerp(tl, bl, radius / leftLen);
                painter.LineTo(tlEnd2);
                currentLen += edgeLen;
            }
            else
            {
