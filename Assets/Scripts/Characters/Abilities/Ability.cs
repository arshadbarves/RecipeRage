...
namespace Characters.Abilities
{
    public abstract class Ability
    {
        ...
        public bool CanUse(BaseController caster, BaseController target = null)
        {
            ...
            bool hasValidTarget = !RequiresTarget || (target != null && Vector3.Distance(caster.transform.position, target.transform.position) <= Range && target.IsEnemy(caster) && !target.stun);
