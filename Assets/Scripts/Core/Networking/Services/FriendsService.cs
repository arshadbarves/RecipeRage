...
namespace Core.Networking.Services
{
    ...
    public class FriendsService : IFriendsService
    {
        ...
        public async void Initialize()
        {
            ...
            Debug.Log("[FriendsService] Initializing with Supabase...");
            ...
            try
            {
                ...
                {
                    Debug.LogError("[FriendsService] Invalid ProductUserId");
                    return;
                }
                ...
                IsInitialized = true;
                Debug.Log($"[FriendsService] Initialized - Friend Code: {MyFriendCode}");
            }
            catch (Exception ex)
            {
                Debug.LogError($"[FriendsService] Initialization failed: {ex.Message}");
            }
        }
        ...
        public async Task<FriendRequest> SendFriendRequestAsync(string friendCode)
        {
            ...
            Debug.Log($"[FriendsService] Sending friend request to: {friendCode}");
            ...
            Debug.Log($"[FriendsService] Friend request sent to {targetUser.display_name}");
        ...
        public async Task AcceptFriendRequestAsync(string requestId)
        {
            ...
            Debug.Log($"[FriendsService] Accepting friend request: {requestId}");
            ...
            Debug.Log("[FriendsService] Friend request accepted");
        }
        ...
        public async Task RejectFriendRequestAsync(string requestId)
        {
            ...
            Debug.Log($"[FriendsService] Rejecting friend request: {requestId}");
            ...
            Debug.Log("[FriendsService] Friend request rejected");
        }
        ...
        public async Task RefreshFriendRequestsAsync()
        {
            ...
            Debug.Log("[FriendsService] Refreshing friend requests...");
            ...
            Debug.Log($"[FriendsService] Found {_pendingRequests.Count} pending requests");
        ...
        public async Task RefreshFriendsAsync()
        {
            ...
            Debug.Log("[FriendsService] Refreshing friends list...");
        ...
        public async Task RemoveFriendAsync(string friendCode)
        {
            ...
            Debug.Log($"[FriendsService] Removing friend: {friend.DisplayName}");
            ...
            Debug.Log("[FriendsService] Friend removed");
        }
        ...
        public async void AddRecentPlayer(ProductUserId productUserId, string displayName)
        {
            ...
            try
            {
                ...
                Debug.Log($"[FriendsService] Adding recent player: {displayName}");
            ...
            {
                Debug.LogError($"[FriendsService] Error adding recent player: {ex.Message}");
            }
        }
        ...
        public void InviteToParty(string friendCode)
        {
            ...
            {
                Debug.LogWarning("[FriendsService] Not in a party");
                return;
            }
            ...
            if (friend == null)
            {
                Debug.LogError($"[FriendsService] Friend not found: {friendCode}");
                return;
            }
            
            if (friend.ProductUserId == null || !friend.ProductUserId.IsValid())
            {
                Debug.LogError($"[FriendsService] Invalid ProductUserId for friend: {friendCode}");
                return;
            }
            
            Debug.Log($"[FriendsService] Inviting {friend.DisplayName} to party");
        ...
        {
            Debug.Log("[FriendsService] Registering user...");
            ...
            if (users != null && users.Length > 0)
            {
                ...
                Debug.Log($"[FriendsService] User exists with code: {MyFriendCode}");
            ...
            else
            {
                ...
                Debug.Log($"[FriendsService] New user registered with code: {MyFriendCode}");
            }
        }
        ...
        private async Task UpdateLastSeenAsync()
        {
            ...
            {
                Debug.LogWarning($"[FriendsService] Failed to update last_seen: {ex.Message}");
            }
        }
