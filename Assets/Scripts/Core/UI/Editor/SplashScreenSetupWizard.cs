...
namespace Core.UI.Editor
{
    ...
    public class SplashScreenSetupWizard : EditorWindow
    {
        ...
        private void CreateTestScene()
        {
            ...
            splashManager._companySplashDocument = companySplashDocument;
            splashManager._gameLogoSplashDocument = gameLogoSplashDocument;
            splashManager._loadingScreenDocument = loadingScreenDocument;
            
            // Set loading tips
            splashManager._loadingTips = _loadingTips;
            
            // Set reference in SplashScreenTester
            tester._splashScreenManager = splashManager;
