...
namespace Gameplay.UI.Features.Gameplay
{
    public class GameplayHudViewModel : BaseViewModel
    {
        ...
        public void TriggerJump() => _mobileControlsManager?.TriggerJump();
        public void TriggerAttack() => _mobileControlsManager?.TriggerAttack();
        public void TriggerSpecial() => _mobileControlsManager?.TriggerSpecial();
        public void TriggerInteract() => _mobileControlsManager?.TriggerInteract();
        ...
        private void TryResolveRuntimeDependencies()
        {
            ...
            {
                _mobileControlsManager = _matchContext.MobileControlsManager;
                didResolveDependency |= _mobileControlsManager != null;
            }
            ...
            MobileControlsVisible.Value = Application.isMobilePlatform && _mobileControlsManager != null;
