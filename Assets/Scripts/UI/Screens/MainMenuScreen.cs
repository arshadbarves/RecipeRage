        ...
        private IEnumerator RotateCharactersCoroutine()
        {
            while (true)
            {
                ...
                while (time < duration)
                {
                    ...
                    _character1.transform.rotation = new Rotate(0, 0, angle);
                    _character2.transform.rotation = new Rotate(0, 0, -angle * 0.5f);
                    _character3.transform.rotation = new Rotate(0, 0, angle);
