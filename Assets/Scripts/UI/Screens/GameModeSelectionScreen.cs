...
namespace RecipeRage.UI.Screens
{
    ...
    public class GameModeSelectionScreen : UIScreen
    {
        ...
        private void SelectGameMode(GameModeType gameMode)
        {
            ...
            _classicModeCard.style.borderWidth = new StyleFloat(gameMode == GameModeType.Classic ? 3 : 0);
            _classicModeCard.style.borderColor = new StyleColor(Color.yellow);
            
            _timeAttackModeCard.style.borderWidth = new StyleFloat(gameMode == GameModeType.TimeAttack ? 3 : 0);
            _timeAttackModeCard.style.borderColor = new StyleColor(Color.yellow);
            
            _teamBattleModeCard.style.borderWidth = new StyleFloat(gameMode == GameModeType.TeamBattle ? 3 : 0);
            _teamBattleModeCard.style.borderColor = new StyleColor(Color.yellow);
            
            _challengeModeCard.style.borderWidth = new StyleFloat(gameMode == GameModeType.Challenge ? 3 : 0);
            _challengeModeCard.style.borderColor = new StyleColor(Color.yellow);
