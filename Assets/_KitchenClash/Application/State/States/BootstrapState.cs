...
namespace KitchenClash.Application.State.States
{
    public class BootstrapState : BaseState
    {
        ...
        private readonly Domain.Interfaces.IEncryptionService _encryptionService;
        private readonly IMaintenanceService _maintenanceService;
        private readonly IGameStateManager _stateManager;
        private readonly Domain.Interfaces.IEventBus _eventBus;
        ...
        public BootstrapState(
            ...
            Domain.Interfaces.IEncryptionService encryptionService,
            IMaintenanceService maintenanceService,
            IGameStateManager stateManager,
            Domain.Interfaces.IEventBus eventBus)
        {
