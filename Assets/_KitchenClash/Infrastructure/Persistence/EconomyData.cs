...
namespace KitchenClash.Infrastructure.Persistence
{
    ...
    public class EconomyData : ISerializationCallbackReceiver
    {
        ...
        public void OnBeforeSerialize()
        {
            ...
            foreach (KeyValuePair<string, long> kvp in Balances) { _balanceKeys.Add(kvp.Key); _balanceValues.Add(kvp.Value); }
            ...
            foreach (KeyValuePair<string, string> kvp in Data) { _dataKeys.Add(kvp.Key); _dataValues.Add(kvp.Value); }
        }
        ...
        public void OnAfterDeserialize()
        {
            ...
            foreach (string item in _inventoryItems)
            {
                Inventory.Add(item);
            }
